      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <form action={importProductsFromCsv} className="grid gap-4">
            <Field label="Archivo CSV" hint="Columnas: nombre, marca, modelo, sku, categoria, condicion, stock, stockMinimo, costoUSD, precioVentaBaseUSD. Condicion puede ser nuevo o refurbished.">
        ...
        <Card>
          ...
          <p className="mb-4 text-sm text-slate-400">Incluye ID, SKU, categoria, stock, costos, precios calculados, tasas usadas, margen y fechas.</p>
